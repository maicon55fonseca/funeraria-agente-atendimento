    ...
    *,
    ...
    with httpx.Client(base_url=base, headers=headers, timeout=120.0) as http:
        ...
        system = (
            ...
            "OBRIGATÓRIO ler instrucao_obrigatoria_imagem_ou_documento, instrucao_situacao_atual e situacoes_comportamento.imagem_ou_documento "
            "(Comportamento → Imagem ou PDF) — identifique do que se trata o arquivo antes de responder; não invente finalidade. "
            ...
            "(parcelas mais antigas = primeiros itens de parcelas_em_aberto_lista). "
            ...
            "Para 'de qual mês é essa parcela', use mes_referencia_vencimento do parcelas_em_aberto_lista. "
