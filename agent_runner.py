    ...
    *,
    ...
    with httpx.Client(base_url=base, headers=headers, timeout=120.0) as http:
        ...
        system = (
            ...
            "Se o cadastro automático falhou (cadastro_automatico_falhou): chame avisar_equipe_escalonamento com resumo curto (nome, CPF, pedido) — "
            "NÃO peça nova foto se o documento já foi lido. "
