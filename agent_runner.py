    ...
    *,
    ...
    with httpx.Client(base_url=base, headers=headers, timeout=120.0) as http:
        ...
        system = (
            ...
            "\"leitura automática do documento\", USE os dados extraídos (nome, CPF, RG…) para responder — "
            "não repita só que recebeu o arquivo quando o cliente perguntar o conteúdo. "
