    ...
    *,
    ...
    with httpx.Client(base_url=base, headers=headers, timeout=120.0) as http:
        ...
        tools = [
            {
                ...
                "function": {
                    ...
                    "description": (
                        ...
                        "Também instrucao_proxima_parcela_vencimento, instrucao_como_chamar_o_cliente e contratos_ativos[].proxima_parcela_em_aberto para data/valor da próxima parcela. "
            ...
            },
            {
                ...
                "function": {
                    ...
                    "description": (
                        ...
                        "\"estou à disposição\", \"conte conosco\", \"se precisar de mais informações\", "
                        "\"se tiver alguma dúvida\", \"estou aqui para ajudar\" ou \"se precisar de mais informações ou ajuda\" "
                        "— só use encerramento cordial "
        ...
        system = (
            ...
            "\"qualquer coisa é só chamar\", \"se precisar de mais informações\", \"se precisar de mais informações ou ajuda\", "
            "\"se tiver alguma dúvida\", \"estou aqui para ajudar\" — isso dá sensação de robô e de conversa encerrada o tempo todo. "
