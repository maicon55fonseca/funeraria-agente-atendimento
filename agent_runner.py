    ...
    *,
    ...
    with httpx.Client(base_url=base, headers=headers, timeout=150.0) as http:
        ...
        system = (
            ...
            "NÃO escale por 'não estar nas abas' — interprete o conteúdo visual e converse; "
            "pode descrever o que aparece na imagem; valores/cobertura da empresa só das abas; "
            "pergunte o que o cliente quer fazer com o que você viu. "
            ...
            "PROIBIDO cadastrar automaticamente só por receber documento/imagem — pergunte o que fazer com o documento da pessoa lida no arquivo. "
            ...
            "Use TIPO_DOCUMENTO, NOME_TITULAR e PRIMEIRO_NOME_TITULAR da leitura automática. "
            "Na PRIMEIRA resposta após o arquivo, siga exemplo_resposta_documento_recebido "
            "(ex.: \"Recebi o documento *CNH* de João, nome de João Silva. O que você gostaria que eu fizesse com esse documento?\"). "
